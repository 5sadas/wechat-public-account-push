export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxd600f868d6ce4f2d",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "4e24199867a6abb70bad3c8a071d5f22",
  ...
  USERS: [
    {
      ...
      id: "oRw826vf-Kzj89ayqaziK-JjzcIc",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "TYMEFNjHeyIU0OQw6BfCvG2Hg_cYNZyVvuZQg9nUmsg",
      // 所在省份
      province: "广西",
      // 所在城市
      city: "贺州",
